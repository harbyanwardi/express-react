...
const KategoriAdd = () => {
  ...
  const { data, token, refreshToken } = useTokenRefresh();
  ...
  return (
    <div>
      ...
      <main className="flex-1 p-8 overflow-auto">
        <h1 className="text-3xl font-bold mb-10">Add Data For this Kategori </h1>
        <hr className="w-full" />
        <div className="flex justify-center items-center h-full">
          <section className="p-8 w-full max-w-md">
            <h1 className="pb-3 font-semibold text-xl text-gray-900">Add Kategori</h1>
